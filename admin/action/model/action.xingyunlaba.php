        ...
        for ($i=0;$i>$diff;$i--){
            ...
            foreach (Config_Game::$game as $gameid=>$gamename){
                foreach (Config_Game::$clientTyle as $ctype=>$clientname){
                    $userNum    = Loader_Redis::common()->hGetAll("xingyunlabaUsernum|$gameid|$ctype|$time");
                    $userCi     = Loader_Redis::common()->get("xingyunlabaUserci|$gameid|$ctype|$time", false, false);
                    $canyuNum   = Loader_Redis::common()->hGetAll("xingyunlabaCanyunum|$gameid|$ctype|$time");
                    $canyuCi    = Loader_Redis::common()->get("xingyunlabaCanyuci|$gameid|$ctype|$time", false, false);
                    $HS         = Loader_Redis::common()->get("xingyunlabaIncome|$gameid|$ctype|$time", false, false);
                    $FF         = Loader_Redis::common()->get("xingyunlabaFafang|$gameid|$ctype|$time", false, false);
                    ...
                    $total_game[$time][$gameid]['huishou']      += $HS;
                    ...
                    $total_ctype[$time][$gameid][$ctype]['huishou']      += $HS;
