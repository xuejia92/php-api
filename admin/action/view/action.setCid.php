...
<div class="pageContent">	
	<form method="post" action="?m=action&p=actionconfig&act=addcid&tapid=<?php echo $tapid?>&navTabId=action_modify&close=1" class="pageForm required-validate"  onsubmit="return iframeCallback(this, dialogAjaxDone)">
		...
		<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit">增加</button></div></div></li>
