...
class Config_Yule{
    ...
    public static function getYuleInfo($aUser){
    	...
    	$yuleInfo['yuleconfig'][0]['ip'] 			= "66778899.biz";	  					 //娱乐场IP
    	$yuleInfo['yuleconfig'][0]['port'] 			= 16000;				  					 //娱乐场端口
    	...
    	$yuleInfo['yuleconfig'][1]['ip'] 			= "66778899.biz";	  					 //跑马场IP //"192.168.0.188";"121.201.0.148"
    	$yuleInfo['yuleconfig'][1]['port'] 			= 16000;				  					 //跑马场端口 //7000;
    	...
    	$yuleInfo['yuleconfig'][2]['ip'] 			= "66778899.biz";	  					 //龙虎斗IP //"192.168.0.188";"121.201.0.148"
    	$yuleInfo['yuleconfig'][2]['port'] 			= 16000;				  					 //龙虎斗端口 //7000;
    	...
    	$yuleInfo['yuleconfig'][3]['ip'] 			= "66778899.biz";	  					 //捕鱼IP //"192.168.0.188";"121.201.0.148"
    	$yuleInfo['yuleconfig'][3]['port'] 			= 18000;				  					 //捕鱼端口 //7000;
    	...
    	//	$rank  = $mid % 5;
        //    $yuleInfo['yuleconfig'][3]['ip'] 			= "139.129.201.216";
