...
class ApnsPHP_Message
{
	...
	{
		return $this->_pushId = $pushId;
	}
		/**
	 * Get the ruleId
	 *
	 * @return @type string ruleId.
	 */
	...
	protected function _getPayload()
	{
		...
		if (isset($this->_pushId)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['pushId'] = (int)$this->_pushId;
		}
		if (isset($this->_ruleId)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['ruleId'] = (int)$this->_ruleId;
		}
		if (is_array($this->_aCustomProperties)) {
