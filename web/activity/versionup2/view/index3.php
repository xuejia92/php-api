...
<body>
    <div class="bg"></div>
    <div>
        <div class="absolute" style=" bottom: 0; width: 100%; height: 100%; background: url(web/activity/versionup2/image/ddz_1888.png) no-repeat; background-size: 50%; background-position: 50%;">
            <div class="absolute" style="top: 63%; left: 45%;">
                <div style="width: 60%;">
