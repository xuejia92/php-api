...
.bg {
	background: url(web/activity/versionup2/image/hdzxd.jpg) no-repeat;
...
<body>
    <div class="bg"></div>
    <div>
        <div class="absolute" style=" bottom: 0; width: 100%; height: 100%; background: url(web/activity/versionup2/image/showhand_midbg.png) no-repeat; background-size: 50%; background-position: 50%;">
            <div class="absolute" style="top: 58%; left: 53%;">
                <div style="width: 60%;">
